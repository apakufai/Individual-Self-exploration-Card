...
# ВВОД ДАННЫХ ПОЛЬЗОВАТЕЛЯ
    ...
    time.sleep(0.1)
    inputBirthyear.send_keys("1901")
    time.sleep(0.1)
    inputCategory.select_by_value("Собственник малого бизнеса")
    time.sleep(0.1)
    inputEmail.send_keys("test1@mail.ru")
    time.sleep(0.1)
...
# Ждём минуту преед обновлением страницы
    time.sleep(60)
...
# ВВОД ДАННЫХ ПОЛЬЗОВАТЕЛЯ
    ...
    # ВВЕДЕНЫ ВЕРНЫЕ ДАННЫЕ
    inputName.send_keys("Рошандиателлинешьяунневешенк")
    time.sleep(0.1)
    inputSurname.send_keys("Вольфшлегельштайнхаузенбергедорф")
    time.sleep(0.1)
    inputSexMale.click()
    time.sleep(0.1)
    inputBirthyear.send_keys("1902")
    time.sleep(0.1)
    inputCategory.select_by_value("Собственник среднего бизнеса")
    time.sleep(0.1)
    inputEmail.send_keys("test2@mail.ru")
    time.sleep(0.1)
    inputAgreement.click()
    time.sleep(0.8)
    btn_UDI_next.click()
