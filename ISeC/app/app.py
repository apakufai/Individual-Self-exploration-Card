...
def generate_and_download_pdf():
    ...
    # Отправляем данные в session
    session['ISeC_results'] = request.json
    
    # Извлекаем из session ключ 'ISeC_results' со значением-массивом и вычленяем из массива все пары
    for key, value in session['ISeC_results'].items():
        session[key] = value
    ...
    with user_lock:
        ...
        userSurname = session.get('userSurname')
        userSex = session.get('userSex')
        userBirthyear = int(session.get('userBirthyear'))
        userCategory = session.get('userCategory')
        userEmail = session.get('userEmail')
        
        adaptation_1 = int(session.get('adaptation_1'))
        compromise_1 = int(session.get('compromise_1'))
        bidding_1 = int(session.get('bidding_1'))
        threat_1 = int(session.get('threat_1'))
        logicArgument_1 = int(session.get('logicArgument_1'))
        emotionsArgument_1 = int(session.get('emotionsArgument_1'))
        adaptationCount_1 = float(session.get('adaptationCount_1'))
        compromiseCount_1 = float(session.get('compromiseCount_1'))
        biddingCount_1 = float(session.get('biddingCount_1'))
        threatCount_1 = float(session.get('threatCount_1'))
        logicArgumentCount_1 = float(session.get('logicArgumentCount_1'))
        emotionsArgumentCount_1 = float(session.get('emotionsArgumentCount_1'))

        adaptation_2 = int(session.get('adaptation_2'))
        compromise_2 = int(session.get('compromise_2'))
        threat_2 = int(session.get('threat_2'))
        cooperation_2 = int(session.get('cooperation_2'))
        avoidance_2 = int(session.get('avoidance_2'))
        adaptationCount_2 = float(session.get('adaptationCount_2'))
        compromiseCount_2 = float(session.get('compromiseCount_2'))
        threatCount_2 = float(session.get('threatCount_2'))
        cooperationCount_2 = float(session.get('cooperationCount_2'))
        avoidanceCount_2 = float(session.get('avoidanceCount_2'))

        adaptation_3 = int(session.get('adaptation_3'))
        threat_3 = int(session.get('threat_3'))
        cooperation_3 = int(session.get('cooperation_3'))
        adaptationCount_3 = float(session.get('adaptationCount_3'))
        threatCount_3 = float(session.get('threatCount_3'))
        cooperationCount_3 = float(session.get('cooperationCount_3'))

        understandingOfStyles_4 = int(session.get('understandingOfStyles_4'))
        strengthInstallation_4 = int(session.get('strengthInstallation_4'))
        manipulationInstallation_4 = int(session.get('manipulationInstallation_4'))
        negotiationsInstallation_4 = int(session.get('negotiationsInstallation_4'))
        strengthInstallationCount_4 = float(session.get('strengthInstallationCount_4'))
        manipulationInstallationCount_4 = float(session.get('manipulationInstallationCount_4'))
        negotiationsInstallationCount_4 = float(session.get('negotiationsInstallationCount_4'))

        adaptation_5 = int(session.get('adaptation_5'))
        bidding_5 = int(session.get('bidding_5'))
        logicArgument_5 = int(session.get('logicArgument_5'))
        emotionsArgument_5 = int(session.get('emotionsArgument_5'))
        avoidance_5 = int(session.get('avoidance_5'))
        adaptationCount_5 = float(session.get('adaptationCount_5'))
        biddingCount_5 = float(session.get('biddingCount_5'))
        logicArgumentCount_5 = float(session.get('logicArgumentCount_5'))
        emotionsArgumentCount_5 = float(session.get('emotionsArgumentCount_5'))
        avoidanceCount_5 = float(session.get('avoidanceCount_5'))

        logicArgument_6 = int(session.get('logicArgument_6'))
        emotionsArgument_6 = int(session.get('emotionsArgument_6'))
        logicArgumentCount_6 = float(session.get('logicArgumentCount_6'))
        emotionsArgumentCount_6 = float(session.get('emotionsArgumentCount_6'))
